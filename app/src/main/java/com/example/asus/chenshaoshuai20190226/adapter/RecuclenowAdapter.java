...
public class RecuclenowAdapter extends RecyclerView.Adapter<RecuclenowAdapter.ViewHolder> {
    private Context mContext;
    private List<NowMovieBean.ResultBean> mData;

    public RecuclenowAdapter(Context mContext) {
    ...
    public void setData(List<NowMovieBean.ResultBean> result) {
        this.mData = result;
